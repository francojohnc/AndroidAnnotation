package co.startidea.processor;
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        if (!roundEnv.processingOver()) {
            ...
            for (TypeElement typeElement : typeElements) {
                //get basic info of the element
                String packageName = elementUtils.getPackageOf(typeElement).getQualifiedName().toString();
                String typeName = typeElement.getSimpleName().toString();
                ClassName className = ClassName.get(packageName, typeName);//co.startidea.app.MainActivity
                ClassName generatedClassName = ClassName.get(packageName, NameStore.getGeneratedClassName(typeName));//co.startidea.app.MainActivity$Binding
                ...
                //add statement list of variable need to bind
